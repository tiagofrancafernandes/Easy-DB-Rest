    ...
    <div class="p-8 h-full overflow-y-auto">
        <div class="max-w-6xl mx-auto space-y-12">
            ...
            <header class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-zinc-500 mt-2 flex items-center gap-2">
                        ...
                        Connected to
                        <span class="text-on-surface font-bold">{{ currentConnection?.name }}</span>
                    </p>
                </div>
                <div class="bg-zinc-900/50 border border-zinc-800 px-4 py-2 rounded-sm flex items-center gap-3">
                    ...
                    <div
                        class="w-2 h-2 bg-emerald-500 rounded-full animate-pulse shadow-[0_0_8px_rgba(16,185,129,0.5)]"
                    ></div>
                </div>
            </header>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div
                    class="bg-surface border border-zinc-900 p-6 rounded-sm shadow-xl hover:border-emerald-400/30 transition-all"
                >
            ...
            <!-- Databases List -->
            <section>
                <h3 class="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-600 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    >
                        ...
                        <Icon
                            v-if="db === currentConnection?.database"
            ...
            <section class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div
                    class="bg-zinc-900/20 border border-dashed border-zinc-800 p-8 rounded flex flex-col items-center justify-center text-center space-y-4"
                >
                    ...
                    <div>
                        ...
                        <p class="text-sm text-zinc-500 mt-1 max-w-xs">
                            Our engine detected 3 tables without proper primary keys. Consider adding them to improve
                            performance.
                        </p>
                    </div>
                    <button
                        class="text-xs font-black text-amber-400 uppercase tracking-widest hover:text-white transition-colors"
                    >
                        View Details
                    </button>
                </div>
                ...
                >
                    ...
                    <div>
                        ...
                        <p class="text-sm text-zinc-500 mt-1 max-w-xs">
                            All connection parameters are encrypted. No plain-text credentials found in logs.
                        </p>
                    </div>
                    <button
                        class="text-xs font-black text-blue-400 uppercase tracking-widest hover:text-white transition-colors"
                    >
                        Security Settings
                    </button>
                </div>
